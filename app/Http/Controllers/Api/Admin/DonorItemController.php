...
//        $this->middleware(['permission:Admin']);
    ...
    public function index(): JsonResponse
    {
        ...
        return $this->showAll($data['donorItem'], DonorItemResource::class, __($data['message']));
    }

    public function show(donorItem $donorItem): JsonResponse
    {
        $data = $this->donorItemRepository->show($donorItem);
        return $this->showOne($data['donorItem'], DonorItemResource::class, __($data['message']));
    }
    ...
    public function destroy(donorItem $donorItem): JsonResponse
    {
        ...
        return response()->json(['message' => __($data['message'])], $data['code']);
    }
